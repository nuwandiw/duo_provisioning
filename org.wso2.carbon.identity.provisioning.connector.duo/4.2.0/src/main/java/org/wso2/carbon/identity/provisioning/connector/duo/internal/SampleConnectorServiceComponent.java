...
/**
 * @scr.component name=
 *                "org.wso2.carbon.identity.provisioning.connector.duo.internal.SampleConnectorServiceComponent"
 *                immediate="true"
 */
public class SampleConnectorServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            DuoProvisioningConnectorFactory salesforceProvisioningConnectorFactory = new DuoProvisioningConnectorFactory();
